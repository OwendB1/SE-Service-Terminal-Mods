...
for (const mod of ["ServiceTerminalFramework", "ShipInsurance"]) {
...
assert.match(workflow, /ServiceTerminalFramework\/workshop\/\*\*/);
assert.match(workflow, /ShipInsurance\/workshop\/\*\*/);
